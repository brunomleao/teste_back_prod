...
class Triangulation {
  ...
  yPointA1toA2() {              // Formula que calcula a coordenada y do Ponto B usando apenas A1 e A2
  ...
  xPointA1toA2() {  // Formula que calcula a coordenada x do Ponto B usando apenas A1 e A2
    let dA1to2 = Math.pow(this.distancesList[0], 2);
    let yb = this.yPointA1toA2();
    let xb = Math.sqrt(Math.abs(dA1to2 - yb));
    return (xb);
  };
  yPointA1toA3() {  // Formula que calcula a coordenada x do Ponto B usando apenas A1 e A3
    let dA1to2 = Math.pow(this.distancesList[0], 2);
  ...
  xPointA1toA3() {  // Formula que calcula a coordenada y do Ponto B usando apenas A1 e A3
    let dA1to2 = Math.pow(this.distancesList[0], 2);
